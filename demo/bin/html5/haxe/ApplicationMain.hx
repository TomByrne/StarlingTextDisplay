...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TextDisplayTest", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TextDisplayTest", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "112";
		app.meta["company"] = "";
		app.meta["file"] = "TextDisplayTest";
		app.meta["name"] = "Text Display Test";
		app.meta["packageName"] = "imagsyd.textdisplay.test";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("TextDisplayTest")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess TextDisplayTest.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"TextDisplayTest\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"TextDisplayTest\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends TextDisplayTest {}
#else
class DocumentClass
{
